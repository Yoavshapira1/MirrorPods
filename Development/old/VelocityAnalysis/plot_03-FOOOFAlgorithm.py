...
# Load data
subj = Subject(r'C:\Users\yoavsha\Desktop\LSL\Tapper\Data_backup_22.8\s10_no_0')
session = subj.sessions[circles_big]
velocity_vec_filtered, sample_rate = session.vel_filtered, session.sample_rate
powers, freqs = plt.psd(velocity_vec_filtered, 512, sample_rate)
